...
private void carinfo(){
        try{
         ...
         rs=pst.executeQuery();
         cri.setModel(DbUtils.resultSetToTableModel(rs));
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Car Information Records");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(360, 80, 240, 50);
        ...
        cri.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(cri);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(100, 140, 729, 250);
    ...
    private javax.swing.JTable cri;
